...
public class ReservationController {
    ...
    public @ResponseBody Result<Page> list(Reservation reservation, HttpServletRequest request) {
	...
	public @ResponseBody Result create(@RequestBody Reservation reservation) {
		if (reservation != null) {
    ...
    public @ResponseBody Result<ReservationVo> load(@PathVariable Long id) {
	...
	public @ResponseBody Result update(@PathVariable Long id ,@RequestBody Reservation reservation) {
